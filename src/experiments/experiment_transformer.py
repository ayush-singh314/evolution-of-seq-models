"""
Experiment script for Transformer model.
"""
...
def main():
    ...
    results = {
        ...
        'generation_sample': generated.tolist()
    }
    
    import json
    results_path = Path(__file__).parent.parent.parent / "outputs" / "transformer_results.json"
    with open(results_path, 'w') as f:
        json.dump(results, f, indent=2, default=str)
    
    logger.info(f"Results saved to {results_path}")
    logger.info("Transformer experiment completed!")
